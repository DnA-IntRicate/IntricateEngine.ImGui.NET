...
namespace IntricateEngine.ImGui
{
    ...
    public readonly unsafe partial struct ImFontPtr
    {
        ...
        public ImVec2 CalcTextSizeA(float size, float max_width, float wrap_width, ReadOnlySpan<char> text_begin)
        {
            ...
            ImVec2 ret = ImGuiNative.ImFont_CalcTextSizeA((ImFont*)(NativePtr), size, max_width, wrap_width, native_text_begin, native_text_begin+text_begin_byteCount, out_remaining);
            if (text_begin_byteCount > Util.StackAllocationSizeLimit)
            {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
        public ImVec2 CalcTextSizeA(float size, float max_width, float wrap_width, ReadOnlySpan<char> text_begin, out byte* out_remaining)
        {
            byte* native_text_begin;
            int text_begin_byteCount = 0;
                text_begin_byteCount = Encoding.UTF8.GetByteCount(text_begin);
            ...
            {
                ImVec2 ret = ImGuiNative.ImFont_CalcTextSizeA((ImFont*)(NativePtr), size, max_width, wrap_width, native_text_begin, native_text_begin+text_begin_byteCount, native_out_remaining);
                if (text_begin_byteCount > Util.StackAllocationSizeLimit)
                {
                    Util.Free(native_text_begin);
                }
...
#endif
        public ImVec2 CalcTextSizeA(float size, float max_width, float wrap_width, string text_begin, out byte* out_remaining)
        {
            byte* native_text_begin;
            int text_begin_byteCount = 0;
                text_begin_byteCount = Encoding.UTF8.GetByteCount(text_begin);
        ...
        public void RenderChar(ImDrawListPtr draw_list, float size, ImVec2 pos, uint col, ushort c)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
            ImVec4* cpu_fine_clip = null;
            ImGuiNative.ImFont_RenderChar((ImFont*)(NativePtr), native_draw_list, size, pos, col, c, cpu_fine_clip);
        }
        public void RenderChar(ImDrawListPtr draw_list, float size, ImVec2 pos, uint col, ushort c, ref ImVec4 cpu_fine_clip)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
            fixed (ImVec4* native_cpu_fine_clip = &cpu_fine_clip)
            {
                ImGuiNative.ImFont_RenderChar((ImFont*)(NativePtr), native_draw_list, size, pos, col, c, native_cpu_fine_clip);
            }
        }
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
        public void RenderText(ImDrawListPtr draw_list, float size, ImVec2 pos, uint col, ImVec4 clip_rect, ReadOnlySpan<char> text_begin)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
            byte* native_text_begin;
            int text_begin_byteCount = 0;
            ...
            ImDrawTextFlags flags = (ImDrawTextFlags)0;
...
#endif
        public void RenderText(ImDrawListPtr draw_list, float size, ImVec2 pos, uint col, ImVec4 clip_rect, string text_begin)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
            byte* native_text_begin;
            int text_begin_byteCount = 0;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
        public void RenderText(ImDrawListPtr draw_list, float size, ImVec2 pos, uint col, ImVec4 clip_rect, ReadOnlySpan<char> text_begin, float wrap_width)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
            byte* native_text_begin;
            int text_begin_byteCount = 0;
...
#endif
        public void RenderText(ImDrawListPtr draw_list, float size, ImVec2 pos, uint col, ImVec4 clip_rect, string text_begin, float wrap_width)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
            byte* native_text_begin;
            int text_begin_byteCount = 0;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_1_OR_GREATER
        public void RenderText(ImDrawListPtr draw_list, float size, ImVec2 pos, uint col, ImVec4 clip_rect, ReadOnlySpan<char> text_begin, float wrap_width, ImDrawTextFlags flags)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
            byte* native_text_begin;
            int text_begin_byteCount = 0;
...
#endif
        public void RenderText(ImDrawListPtr draw_list, float size, ImVec2 pos, uint col, ImVec4 clip_rect, string text_begin, float wrap_width, ImDrawTextFlags flags)
        {
            ImDrawList* native_draw_list = draw_list.NativePtr;
            byte* native_text_begin;
            int text_begin_byteCount = 0;
