...
namespace IntricateEngine.ImGui
{
    ...
    public readonly unsafe partial struct ImFontAtlasPtr
    {
        ...
        public ref ImVec2 TexUvScale => ref Unsafe.AsRef<ImVec2>(&NativePtr->TexUvScale);
        public ref ImVec2 TexUvWhitePixel => ref Unsafe.AsRef<ImVec2>(&NativePtr->TexUvWhitePixel);
        ...
        public RangeAccessor<ImVec4> TexUvLines => new RangeAccessor<ImVec4>(&NativePtr->TexUvLines_0, 33);
        ...
        public ImVector<nint> DrawListSharedDatas => new ImVector<nint>(NativePtr->DrawListSharedDatas);
        ...
        public ref nint OwnerContext => ref Unsafe.AsRef<nint>(&NativePtr->OwnerContext);
