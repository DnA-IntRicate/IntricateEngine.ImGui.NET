...
namespace IntricateEngine.ImGui
{
    ...
    public readonly unsafe partial struct ImFontAtlasRectPtr
    {
        ...
        public ref ImVec2 uv0 => ref Unsafe.AsRef<ImVec2>(&NativePtr->uv0);
        public ref ImVec2 uv1 => ref Unsafe.AsRef<ImVec2>(&NativePtr->uv1);
        public void Destroy()
        {
