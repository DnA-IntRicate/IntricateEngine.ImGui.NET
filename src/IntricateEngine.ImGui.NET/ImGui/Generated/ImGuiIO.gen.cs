...
namespace IntricateEngine.ImGui
{
    ...
    public readonly unsafe partial struct ImGuiIOPtr
    {
        ...
        public ref ImVec2 DisplayFramebufferScale => ref Unsafe.AsRef<ImVec2>(&NativePtr->DisplayFramebufferScale);
        ...
        public ref ImVec2 MouseDelta => ref Unsafe.AsRef<ImVec2>(&NativePtr->MouseDelta);
        public ref nint Ctx => ref Unsafe.AsRef<nint>(&NativePtr->Ctx);
        public ref ImVec2 MousePos => ref Unsafe.AsRef<ImVec2>(&NativePtr->MousePos);
        ...
        public ref ImVec2 MousePosPrev => ref Unsafe.AsRef<ImVec2>(&NativePtr->MousePosPrev);
        public RangeAccessor<ImVec2> MouseClickedPos => new RangeAccessor<ImVec2>(&NativePtr->MouseClickedPos_0, 5);
        ...
        public RangeAccessor<ImVec2> MouseDragMaxDistanceAbs => new RangeAccessor<ImVec2>(&NativePtr->MouseDragMaxDistanceAbs_0, 5);
