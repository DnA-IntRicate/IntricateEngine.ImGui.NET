...
namespace IntricateEngine.ImGui
{
    ...
    public readonly unsafe partial struct ImTextureDataPtr
    {
        ...
        public ref nint TexID => ref Unsafe.AsRef<nint>(&NativePtr->TexID);
        ...
        {
            nint ret = ImGuiNative.ImTextureData_GetTexID((ImTextureData*)(NativePtr));
            return ret;
        }
        ...
        public void SetTexID(nint tex_id)
        {
